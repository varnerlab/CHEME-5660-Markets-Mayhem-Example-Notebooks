...
# ╔═╡ 35f92d2e-4481-4c5a-9690-1f8398408949
begin
...
md"""
### CHEME 5660: Calculating the Price of a Zero-Coupon U.S. Treasury Bill
"""

# ╔═╡ c3ccd0ab-8c15-4501-b92a-773a8999f454
html"""
...
# ╔═╡ f10a117c-7b17-4772-aa90-a7dbc7931450
md"""
#### Introduction
...
# ╔═╡ 0152f370-06e9-4304-946f-57e1c21af7f1
md"""
#### Problem Statement

Compute the fair price for a T-bill with a par value of \$1,000 and T = 26-week duration as a function of annualized market interest rate $\bar{r}$.
"""

# ╔═╡ 85f548b4-174e-4de8-9b50-7af30d1f73c9
md"""
#### Materials and Methods
"""

# ╔═╡ a9c2ee12-1bdf-4d31-ae07-6a8f5080826e
# ------------------------------------------------------------------------------------------- #
...
# ------------------------------------------------------------------------------------------- #
function price(Vₚ::Float64, T::Union{Float64, Int64}, r̄::Float64)::Float64
...
# ╔═╡ 6ab6f4d2-f16c-404e-b6fc-31b335ad6da0
md"""
#### Results
"""

# ╔═╡ 7fcbba91-1e66-43fb-b25d-3f210aeb8e8b
md"""
Before we do anything, let's test the price function against examples we find online. One example is in lecture notes from [IEOR 4700 at Columbia by Prof. K. Sigman](http://www.columbia.edu/~ks20/FE-Notes/FE-Notes-Sigman.html).
"""

# ╔═╡ 95c23585-74c4-4625-b0b6-1348d0068e04
with_terminal() do

	# setup the calculation -
	Vₚ = 1000.0 # par value
	T = 5 		# duration in years
	r̄ = 0.04 	# annual market interest rate

	# compute the price -
	Vᵦ = price(Vₚ, T, r̄)

	# display -
	println("IEOR 4700 Columbia test calculation (Vₚ,T,r̄) = ($(Vₚ),$(T),$(r̄)): Vᵦ = $(Vᵦ)")
end

# ╔═╡ 48f1a358-6bd1-4bf4-82f0-641626fc0d45
md"""
Let's calculate (and visualize) how the Vᵦ changes as a function of the market interest rate r̄
"""

# ╔═╡ 2ed10ba4-9b52-49e6-99da-458bc8fc8835
begin
...
* There is an _inverse_ relationship between the current price of a zero-coupon instrument and the market interest rate; this must be true as the par value (which is in future dollars) is fixed. Thus, higher market interest rates imply lower T-bill prices. 
...
# ╔═╡ 21a450cc-473a-44d9-9a96-0cfe3949bbd1
md"""
#### Additional Resources

* For some additional reading, check out the notes from [IEOR 4700 at Columbia by Prof. K. Sigman](http://www.columbia.edu/~ks20/FE-Notes/FE-Notes-Sigman.html). They are nicely done!
"""

# ╔═╡ 03e491ca-c0e1-4c22-a277-f6c621691594
md"""
...
# ╔═╡ 3ba612ba-0152-11ed-0761-b7d151eff946
html"""
<style>
main {
    max-width: 1200px;
