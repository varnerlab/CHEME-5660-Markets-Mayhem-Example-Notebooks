...
# ╔═╡ b19b1310-27d5-11ed-2386-4b97122a17ca
md"""
### CHEME 5660: Calculating the Present Value of a Future Payment
"""

# ╔═╡ 09ee854d-0301-4f19-ac3c-462af889c01c
html"""
...
# ╔═╡ a7e0aa56-f888-4be8-8387-3a4573c32b70
md"""
### Introduction
"""
...
begin
	...
	# transpose the CF_array -
	CFᵀ = transpose(CF_array)
	...
	scatter!(t_array, CFᵀ[:,3], msc=colorant"#0068AC", mc=:white, lw=2, label="");
	
	plot!(t_array, CFᵀ[:,4], c=colorant"#55565A", lw=2, label="r̄ = $(r_array[4])");
	scatter!(t_array, CFᵀ[:,4], msc=colorant"#55565A", mc=:white, lw=2, label="");

	# labels -
	xlabel!("Time index (AU)", fontsize=18)
	ylabel!("CF₁ (USD today)", fontsize=18)

	# uncomment me to save fig -
	# filename="Fig-PresentValue-FuturePayment.pdf"
