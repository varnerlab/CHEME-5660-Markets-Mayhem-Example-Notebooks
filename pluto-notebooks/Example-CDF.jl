...
md"""
### CHEME 5660: Future Value Calculation using a Continuous Discount Factor
"""
...
begin
	...
	r_array = [0.02 0.04 0.06] 	# discount rate
	CFₒ = 1.0 	# current value
	t_array = range(0, stop = 10, step = 0.01) |> collect
	FV = Array{Float64,2}(undef, length(r_array), length(t_array))
