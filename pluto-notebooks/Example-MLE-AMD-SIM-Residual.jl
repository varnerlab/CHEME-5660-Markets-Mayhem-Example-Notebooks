...
# ╔═╡ 0f528837-9c2a-4fa5-8b66-bd9cb2e1a8f7
begin
...
# ╔═╡ 77798780-1fc8-11ed-0f7e-df433671fc3f
md"""
### CHEME 5660: Maximum Likelihood Estimation (MLE) of the Single Index Model Residual Distribution 
"""

# ╔═╡ 6a851a9e-fd7c-4f82-8708-e728cc679061
html"""
...
# ╔═╡ f48c841e-6763-435a-aa77-d471983c5cda
md"""
### Introduction
"""

# ╔═╡ 639cbb5c-0d87-487e-af6b-2e09f270dc9a
md"""
### Materials and Methods
"""

# ╔═╡ 1d95a235-39ed-435a-9083-576c6c507adc
function compute_log_return_array(data::DataFrame; 
	m::Int64 = 30)::Array{Float64,1}
...
# ╔═╡ 1da9351f-cef4-48f7-84ac-88db4191ef90
md"""
### Results
"""

# ╔═╡ d490a404-57db-4f4f-aaf6-68feb3a7bc7b
begin
...
# ╔═╡ c4c21fb3-a22d-43b7-b977-a88f3b74f0c2
md"""
##### Load the AMD close price data (ℳ = 90 days)
"""

# ╔═╡ e32fd7fb-103c-4818-8990-b26671614667
begin
	...
	r_amd = compute_log_return_array(𝒫_amd; m = 90);
...
# ╔═╡ 9c2ddb2f-164d-412b-8189-715191abc66d
md"""
##### Load the SPY close price data and formulate the X array (ℳ = 90 days)
"""

# ╔═╡ 3d912000-57a5-48ad-94cc-43e488fa75e9
begin
	...
	# compute the return array (default: last thirty days) -
	r_spy = compute_log_return_array(𝒫_spy; m = 90);
...
# ╔═╡ dc7c2877-e9da-4d5a-916f-64ce8a0c93b6
md"""
##### Compute $\theta$ using direct matrix inversion
"""

# ╔═╡ 7189abc0-095e-4cd0-b0b6-2c65eca4bd6b
begin
...
# ╔═╡ ef5fe84b-81a4-45fc-a313-7a2888fae480
md"""
##### Compute $\hat{Y}$ and the residual $\Delta = Y - \hat{Y}$ vector
"""

# ╔═╡ 0de030e3-98d6-41c2-9acc-0232790eef93
begin

	# Compute the Ŷ - the sim predicted firm return 
	Ŷ = X*θ

	# Compute the residual array Δ -
	Δ = Y - Ŷ
...
# ╔═╡ 9b32ee1b-0ebc-453d-9f4d-c88b42d942d1
# fit a Normal distribution using MLE -
ϵ = fit_mle(Normal, Δ)

# ╔═╡ 2b8e5c98-9ec0-44b8-b86a-6d3104aa848e
begin
	plot(ϵ, lw=2, bg="floralwhite", background_color_outside="white", framestyle = :box, fg_legend = :transparent,
		c=colorant"#0068AC", label="Model")
	stephist!(Δ, bins=20, norm=true)
	xlabel!("AMD excess return residual", fontsize=18);
	ylabel!("Probability density", fontsize=18);
end

# ╔═╡ 7637c0b2-75d8-4d70-b438-f2f6c85fe88f
md"""
...
# ╔═╡ 7edb843c-a75a-4a70-83b2-53fc1322faf4
html"""
<style>
main {
    max-width: 1200px;
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "d53ac3461e69dde4528a5aa3f5a13f97de22dc6d"
